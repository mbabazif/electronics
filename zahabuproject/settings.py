"""
Django settings for zahabuproject project.
...
SECRET_KEY = '*m-im9a)=7k75s7ough(g5ly-k*46k=8e++g4gv@%_)c(=_xlx'
...
INSTALLED_APPS = [
    ...
    # local
    'zahabuapp.apps.ZahabuappConfig',
...
ROOT_URLCONF = 'zahabuproject.urls'
...
WSGI_APPLICATION = 'zahabuproject.wsgi.application'
